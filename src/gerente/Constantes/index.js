...
const cotacao = [
    ...
    {title: 'Dupla Chance'},
    {title: 'Handicap - Resultado'},
    {title: 'Placar Exato'},
    {title: 'Gols na Partida'},
    {title: 'Ambos Marcam 1º Tempo - 2º Tempo'},
    {title: 'Gols Ímpar/Par'},
    {title: '1º Tempo - Gols na Partida'},
    {title: 'Primeira Equipe a Marcar'},
    {title: '1º Tempo - Dupla Chance'},
    {title: '1º Tempo - Resultado e Ambos os Times Marcam'},
    {title: '2º Tempo - Casa Marca'},
    {title: 'Time da Casa - Gols Exatos'},
    {title: '1º Tempo - Gols Ímpar/Par'},
    {title: '1º Tempo - Placar Exato'},
    {title: 'Total Exato de Gols'},
    {title: '2º Tempo - Ambos os Times Marcam'},
    {title: 'Tempo com Mais Gols'},
    {title: '2º Tempo - Fora Marca'},
    {title: '1º Tempo - Ambos os Times Marcam'},
    {title: '1º Tempo - Resultado / Total de Gols'},
    {title: 'Times - Para Marcar'},
    {title: 'Resultado / Total de Gols'},
    {title: 'Escanteios'},
    {title: 'Marca 2 ou Mais Gols'},
    {title: '1º Tempo - Gols Exatos'},
    {title: 'Número de Gols'},
    {title: 'Casa - Total de Gols'},
    {title: 'Condicionais'},
    {title: '2º Tempo - Gols Ímpar/Par'},
    {title: 'Time da Fora - Gols Exatos'},
    {title: 'Total de Escanteios'},
    {title: '1º Tempo - Handicap - Resultado'},
    {title: 'Jogador Marca Gol'},
    {title: '1º Tempo - Casa Marca'},
    {title: 'Marca 3 ou Mais Gols'},
    {title: 'Escanteios - 2 Opções'},
    {title: 'Momento do Primeiro Gol'},
    {title: 'Total de Gols / Ambos Marcam'},
    {title: 'Para Ganhar Ambas as Partes'},
    {title: 'Para Marcar em Ambas as Partes'},
    {title: 'Que Jogador Marca o 1º Gol'},
    {title: 'Intervalo / Fim de Jogo'},
    {title: 'Para Ganhar Umas das Partes'},
    {title: '1º Tempo - Resultado'},
    {title: 'Margem de Vitória'},
    {title: 'Para Ganhar a Zero'},
    {title: '1º Tempo - Fora Marca'},
    {title: 'Última Equipe a Marcar'},
    {title: 'Primeiros 10 Minutos (00:00 - 09:59)'},
    {title: '2º Tempo - Gols na Partida'},
    {title: 'Que Jogador Marca o Último Gol'},
    {title: '2º Tempo - Gols Exatos'},
    {title: '2º Tempo - Resultado'},
    {title: '1º Tempo - Escanteios'},
    {title: 'Fora - Total de Gols'},
];
