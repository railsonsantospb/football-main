            ...
            <main className={classes.content}>
                ...
                <Container maxWidth="lg" className={classes.container}>
                        ...
                        <div><fieldset style={{padding: 20}}>
                            ...
                            <br/>
                            90 Minutos de Jogo:
                            Todos os jogos são baseados no resultado ao final dos 90 minutos de jogo.<br/>
                            ...
                            Jogos Adiados, Reagendados ou Abandonados
                             ...
                             Quaisquer jogos não jogados ou adiados serão considerados "Não Participantes” <br/>
                            caso não remarcado e não jogado no período anterior a 48h,  Na eventualidade de <br/>
                            isto acontecer, as apostas serão mantidas. Se for cancelada, todas as apostas <br/>
                            serão canceladas e o dinheiro das apostas devolvidos. Se houver outros jogos em <br/>
                            ...
                            A <b>SONHOBETS</b> não pagará prêmios de jogos que já tenham começados e por erro 
                            ...
                            A <b>SONHOBETS</b> está empenhada em promover o Jogo Responsável. Promovemos o jogo<br/>
                            como uma atividade de lazer e acreditamos que o jogo apenas poderá ser desfrutado <br/>
                            desta forma de se mantiver o controle e jogar de forma responsável. No entanto, <br/>
                            sabemos que para algumas pessoas, o jogo pode deixar de ser uma atividade de lazer<br/> 
                            inofensiva e tornar-se um problema.<br/><br/>

                            1. O jogo deve ser visto como uma forma de entretenimento e não como uma forma de <br/>
                            fazer dinheiro.<br/>
                            ...
                            Se possuir preocupações com o seu jogo, favor nos contactar para o cancelamento <br/>
                            da conta.<br/>
